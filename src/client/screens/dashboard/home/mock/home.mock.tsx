...
export const homeMock: HomeModel = {
  ...
  activeCohorts: [
    ...
    },
    {
      ...
      schedule: { days: ['Mon', 'Wed', 'Fri'], label: 'Mon, Wed, Fri' },
      frequency: 'Sometimes',
      orderStyle: 'Randomize',
    },
    {
      id: 'celtic-mythology',
      rank: 4,
      title: 'Celtic Mythology',
      provider: 'See U in History / Mythology',
      thumbnail: '/mock/thumbnails/civilization.jpeg', // Fallback, doesn't matter too much
      minutesToday: 0,
      dailyGoalMinutes: 20,
      progressPercent: 18,
      schedule: { days: ['Mon', 'Wed', 'Fri'], label: 'Mon, Wed, Fri' },
