    ...
    <div className={`${styles.landing} ${isMobile && mobileView !== 'list' ? styles.panelHidden : ''} ${isMobile && mobileView !== 'chat' ? styles.chatHidden : ''}`}>
      ...
      {message.view === 'community' && (
        <CommunityChat
          ...
          onReply={(messageId, senderName, previewText, senderAvatar) =>
            setCommunityReply({ messageId, senderName, senderAvatar: senderAvatar || '/logos/floating-logo.svg', previewText })
          }
      ...
      {message.view === 'dm' && (
        <DMConversation
          ...
          onReply={(messageId, senderName, previewText, senderAvatar) =>
            setDmReply({ messageId, senderName, senderAvatar: senderAvatar || '/logos/floating-logo.svg', previewText })
          }
