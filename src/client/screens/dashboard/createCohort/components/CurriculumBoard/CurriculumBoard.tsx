                ...
                >
                  {season.lessons.length === 0 ? (
                    <div className={styles.emptySeasonNotice}>
                      <span>Empty season — drag lessons here, or quick add:</span>
                      <div className={styles.quickAddBlock} style={{ display: 'flex', gap: '8px', marginTop: '12px', flexWrap: 'wrap' }}>
                        <button 
                          type="button" 
                          className={styles.quickAddBtn} 
                          onClick={(e) => { e.stopPropagation(); /* actions.addGitHub(season.id) */ }}
                          style={{ display: 'flex', alignItems: 'center', gap: '6px', padding: '6px 12px', borderRadius: '6px', border: '1px dashed #cbd5e1', background: 'transparent', cursor: 'pointer', fontSize: '13px', color: '#475569' }}
                        >
                        ...
                        <button 
                          type="button" 
                          className={styles.quickAddBtn} 
                          onClick={(e) => { e.stopPropagation(); /* actions.addNotion(season.id) */ }}
                          style={{ display: 'flex', alignItems: 'center', gap: '6px', padding: '6px 12px', borderRadius: '6px', border: '1px dashed #cbd5e1', background: 'transparent', cursor: 'pointer', fontSize: '13px', color: '#475569' }}
                        >
