          ...
          <div className={styles.masonryGrid}>
            ...
            <div style={{ display: 'flex', flexDirection: 'column', gap: '12px', padding: '16px', borderRadius: '12px', border: '1px dashed var(--color-border)', backgroundColor: 'var(--color-bg-subtle)' }}>
              ...
              <Button variant="outline" size="sm" onClick={() => {
                const el = document.querySelector('input[placeholder*="Paste"]') as HTMLInputElement;
                if (el) { el.focus(); el.placeholder = "Paste a GitHub repository link..."; }
            ...
            <div style={{ display: 'flex', flexDirection: 'column', gap: '12px', padding: '16px', borderRadius: '12px', border: '1px dashed var(--color-border)', backgroundColor: 'var(--color-bg-subtle)' }}>
              ...
              <Button variant="outline" size="sm" onClick={() => {
                const el = document.querySelector('input[placeholder*="Paste"]') as HTMLInputElement;
                if (el) { el.focus(); el.placeholder = "Paste a Notion page or workspace link..."; }
