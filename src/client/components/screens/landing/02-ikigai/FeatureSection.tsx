            ...
            <div className={styles.featureCopy}>
                ...
                <ul className={styles.featureList}>
                    <li className={styles.featureItem}>
                        <Sparkles className={styles.featureIcon} strokeWidth={2.25} />
                        <span>Automatically picks the right next piece</span>
                    </li>
                    <li className={styles.featureItem}>
                        <Link2 className={styles.featureIcon} strokeWidth={2.25} />
                        <span>Remembers everything for you</span>
                    </li>
                    <li className={styles.featureItem}>
                        <Target className={styles.featureIcon} strokeWidth={2.25} />
                        <span>Adapts to your time, energy, and goals</span>
                    </li>
                    <li className={styles.featureItem}>
                        <TrendingUp className={styles.featureIcon} strokeWidth={2.25} />
