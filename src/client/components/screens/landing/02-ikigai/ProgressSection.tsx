    ...
    return (
        <div className={styles.progressSection}>
            ...
            <div className={styles.calendarPanel}>
                <CalendarMonth month="May" year={2025} youtubeTotal="8h 42m" courseraTotal="9h 16m" historyTotal="7h 48m" days={mayDays} />
                <CalendarMonth month="June" year={2025} youtubeTotal="9h 10m" courseraTotal="9h 24m" historyTotal="7h 20m" days={juneDays} />
                <CalendarMonth month="July" year={2025} youtubeTotal="8h 08m" courseraTotal="9h 20m" historyTotal="7h 40m" days={julyDays} />
            </div>
            ...
            <aside className={styles.progressCard}>
                ...
                <div className={`${styles.progressRow} ${styles.youtube}`}>
                    <img src="/images/icons/youtube-white.webp" alt="" className={styles.progressIcon} />
                ...
                <div className={`${styles.progressRow} ${styles.coursera}`}>
                    <img src="/images/icons/coursera-white.webp" alt="" className={styles.progressIcon} />
                    <span className={styles.progressCheck}>✓</span>
                    <div className={styles.progressInfo}>
