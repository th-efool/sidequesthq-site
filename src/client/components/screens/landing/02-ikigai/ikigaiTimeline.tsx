        ...
        <section className={styles.timeline}>
            ...
            <div className={styles.copy}>
                ...
                <p className={styles.description}>
                    Tiny pockets of time appear all day long. Too short for
                    traditional learning. Long enough to keep your curiosity
                    alive.
                </p>
                ...
                <div className={styles.definition}>
                    ...
                    <div className={styles.definitionContent}>
                        <div className={styles.definitionTitle}>
                            Interstitial Time{" "}
                            <span className={styles.definitionType}>(noun)</span>
                        </div>

                        <p className={styles.definitionText}>
                            The small, in-between pockets of time that occur naturally
                            throughout your day waiting for coffee, commuting,
                            standing in line, or before bed. Individually they feel
                            insignificant. Collectively they add up to hours every
                            week.
                        </p>
                    </div>
                </div>
