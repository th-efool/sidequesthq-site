...
export const messageMock: MessageMock = {
    conversations: [
        ...
        { id: "aarav-mehta", kind: "dm", name: "Aarav Mehta", avatar: avatars[2], sender: "", preview: "Sounds good. See you at 8!", timestamp: "5:36 PM", unreadCount: 1, selected: true },
        { id: "vanshika-iyer", kind: "dm", name: "Vanshika Iyer", avatar: avatars[1], sender: "", preview: "Thanks! 🙌", timestamp: "4:22 PM" },
        { id: "rohan-gupta", kind: "dm", name: "Rohan Gupta", avatar: avatars[0], sender: "", preview: "Shared a file", timestamp: "3:45 PM", unreadCount: 2 },
        { id: "samiksha-sharma", kind: "dm", name: "Samiksha Sharma", avatar: avatars[4], sender: "", preview: "Let's catch up tomorrow", timestamp: "1:15 PM" },
        { id: "arjun-nair", kind: "dm", name: "Arjun Nair", avatar: avatars[3], sender: "", preview: "Got it, thanks!", timestamp: "12:05 PM" },
        { id: "ai-filmmaking-team", kind: "dm", name: "AI Filmmaking Team", avatar: "/images/auth/faceless.webp", sender: "Shaqun", preview: "Check this out", timestamp: "Yesterday", unreadCount: 4 },
        { id: "yash-patil", kind: "dm", name: "Yash Patil", avatar: avatars[0], sender: "", preview: "See you there", timestamp: "Yesterday" },
        { id: "design-thinkers", kind: "dm", name: "Design Thinkers", avatar: "/images/auth/maker.webp", sender: "Ananya", preview: "Shared notes", timestamp: "Wed" },
    ],
    liveSessions: [
