...
export function MessageComposer({
    ...
    const uploadAccept = uploadKind === "video" ? "video/*" : uploadKind === "audio" ? "audio/*" : undefined;
    const sendButton = (
        <button type="submit" className={sendButtonClassName} aria-label="Send message">
            <Send size={21} />
        </button>
    );
        ...
        <form className={styles.composer} onSubmit={submit}>
            ...
            <PillInput
                ...
                rightSlot={(
                    <>
                        <div className={styles.toolWrap}>
                            <button type="button" aria-label="Add emoji" onClick={() => setEmojiOpen((open) => !open)}>
                        ...
                        <button type="button" aria-label="Add image" onClick={() => imageRef.current?.click()}>
                            <ImageIcon size={20} />
                        </button>
