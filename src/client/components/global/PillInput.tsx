...
type PillStyle = CSSProperties & {
  '--pill-input-radius'?: CSSProperties['borderRadius'];
};

export const PillInput = forwardRef<HTMLInputElement | HTMLTextAreaElement, PillInputProps>(
  function PillInput({ leftSlot, rightSlot, radius, className, mode = 'input', ...props }, ref) {
