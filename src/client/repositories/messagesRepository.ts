...
export const messagesRepository = {
    getMessageBase() { return messageMock; },
    getDMConversation() { return dmConversationMock; },
    getEnrolledCohorts() { const home = homeRepository.getHome(); return [...home.activeCohorts, ...home.continueLater]; },
};
