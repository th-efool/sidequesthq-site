...
fs.writeFileSync('src/client/mock/cohorts/feedCohorts.ts', tsContent);
console.log('✓ Successfully wrote src/client/mock/cohorts/feedCohorts.ts with REAL video IDs and chunks!');
